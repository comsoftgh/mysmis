<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="userstutor.aspx.cs" Inherits="mySmis.userstutor" %>
                ...
                <ContentTemplate>
                    ...
                    <div runat="server" id="divLogin" visible="false">
                        <table class="main_table" style="width:500px">
                             <tr>
                                 <td style="width:120px;">Select Tutor :</td>
                                            <td>
