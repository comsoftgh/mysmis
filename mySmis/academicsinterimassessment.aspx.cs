...
namespace mySmis
{
    public partial class academicsinterimassessment : System.Web.UI.Page
    {
        ...
        protected void gvStudents_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
            if (e.Column.Name == "testScore") { ASPxSpinEdit ts = (ASPxSpinEdit)e.Editor; ts.MaxValue = 100 - int.Parse(new InstanceConfigServices().GetConfig("examshigerscore")); }
