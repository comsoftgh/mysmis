<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="usersstudent.aspx.cs" Inherits="mySmis.usersstudent" %>
            ...
            <asp:UpdatePanel ID="UpdatePanelStaff" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <dx:ASPxMenu ID="mMain" runat="server" OnItemClick="mMain_ItemClick"  AllowSelectItem="True" AutoPostBack="true" ShowPopOutImages="True">
                        <Items>
                            <dx:MenuItem Name="mitExcel" Text="Export Excel"></dx:MenuItem>
                    ...
                    <div runat="server" id="divLogin" visible="false" class="appWorkspace">
                        <table class="main_table" style="width:500px">
                            ...
                            <tr>
                                <td></td>
                                <td>
                                                <dx:ASPxButton ID="btnCancel" runat="server" Width="15%" OnClick="btnCancelLogin_Click"  Text="Cancel" >
                                                </dx:ASPxButton>
                                    <dx:ASPxButton ID="btnActive" Visible="false" runat="server" Width="15%" Text="" OnClick="btnActive_Click" >
                                                </dx:ASPxButton>
                                    <dx:ASPxButton ID="btnReset" Visible="false" runat="server" Width="15%"  Text="Reset Password" OnClick="btnReset_Click" >
                                                </dx:ASPxButton>
