...
namespace mySmis
{
    public partial class userstutor : System.Web.UI.Page
    {
        ...
        {
            gvStaff.DataSource = new UserService().GetTutorUsers(new SessionManager().GetUserId(this.Session));
            gvStaff.DataBind();
        }
        private void loadLookups()
        {
            cmbStaffs.DataSource = new TutorService().GetTutorByStaffTypeNotInList("Tutor","Tutor","Tutor", new SessionManager().GetUserId(this.Session));
            cmbStaffs.DataBind();
        }
