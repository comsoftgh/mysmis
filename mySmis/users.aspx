<%@ Page Title="My Account - mySmis MIS" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="mySmis.users" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
            ...
            <asp:UpdatePanel ID="UpdatePanelStaff" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <br />
                    <div runat="server" id="divLogin" visible="false" class="appWorkspace">
                        <table class="main_table" style="width:600px">
                             <tr>
                                 <td class="table_tr_left" >Staff :</td>
                                            <td class="table_tr_right">
                                             <dx:ASPxComboBox ID="cmbStaffs" runat="server" AutoPostBack="True" CallbackPageSize="10" DropDownRows="10" DropDownStyle="DropDown" EnableCallbackMode="True" FilterMinLength="0" AutoResizeWithContainer="true" IncrementalFilteringMode="Contains" TextFormatString="{0} - {1}" ValueField="UserId" Width="100%">
                                                 <Columns>
                                                     <dx:ListBoxColumn Caption="Name" FieldName="xFullName" Visible="true" />
                                                     <dx:ListBoxColumn Caption="User Type" FieldName="Stafftype" Visible="true" />
                                        ...
                                        <tr>
                                            <td class="table_tr_left">Username :</td>
                                            <td class="table_tr_right">
                                                <dx:ASPxTextBox runat="server" ID="txtUserName" Width="70%">
                                        ...
                                        <tr>
                                            <td class="table_tr_left">Password :</td>
                                            <td class="table_tr_right">
                                                <dx:ASPxTextBox runat="server" ID="txtPassword" Password="true" Width="70%">
                                                    <ValidationSettings SetFocusOnError="True" ErrorDisplayMode="Text" >
                            ...
                            <tr>
                                            ...
                                            <td class="table_tr_right" >
                                                <dx:ASPxTextBox runat="server" ID="txtPass" Password="true" Width="70%">
                                                    <ValidationSettings SetFocusOnError="True" ErrorDisplayMode="Text" >
                            ...
                            <tr>
                                ...
                                <td class="table_tr_right">
                                                <dx:ASPxButton ID="btnSaveLogin" runat="server" Width="20%"  Text="Save" OnClick="btnSaveLogin_Click"  >
                                                </dx:ASPxButton>
                                                <dx:ASPxButton ID="btnCancel" runat="server" Width="20%" OnClick="btnCancelLogin_Click"  Text="Cancel" >
                                                </dx:ASPxButton>
                                    <dx:ASPxButton ID="btnActive" Visible="false" runat="server" Width="20%"  Text="" OnClick="btnActive_Click" >
                                                </dx:ASPxButton>
                                    <dx:ASPxButton ID="btnReset" Visible="false" runat="server" Width="20%"  Text="Reset Password" OnClick="btnReset_Click" >
                                                </dx:ASPxButton>
                        ...
                        <dx:ASPxGridView ID="gvStaff" runat="server" AutoGenerateColumns="False" KeyFieldName="UserId" Width="100%" EnableCallBacks="False" OnStartRowEditing="gvStaff_StartRowEditing" Font-Names="Tahoma" Font-Size="11px">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="UserID" VisibleIndex="1" Visible="false" ReadOnly="True" >
                                 ...
                                 <dx:GridViewDataTextColumn FieldName="UserType" VisibleIndex="16" Visible="true" Caption="USER TYPE" ReadOnly="True" >
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="UserName" VisibleIndex="16" Visible="true" Caption="USERNAME" ReadOnly="True" >
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="xFullName" VisibleIndex="16" Visible="true" Caption="STAFF NAME" ReadOnly="True" >
                                </dx:GridViewDataTextColumn>
