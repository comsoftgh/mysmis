<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="libbookauthor.aspx.cs" Inherits="mySmis.libbookauthor" %>
        ...
        <ContentTemplate>
            ...
            <div id="divClasses" runat="server" visible="false" class="appWorkspace">
                <table style="width: 80%;">
                    <tr>
                        <td class="table_tr_left">Full Name :</td>
            ...
            <dx:ASPxGridView KeyFieldName="ID" runat="server" Width="100%" ID="dgAuthor" EnableCallBacks="False" AutoGenerateColumns="False" OnCommandButtonInitialize="dgAuthor_CommandButtonInitialize" OnRowDeleting="dgAuthor_RowDeleting" OnStartRowEditing="dgAuthor_StartRowEditing">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Name="AuthorName" FieldName="AuthorName" Caption="AUTHOR's NAME" VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Name="Gender" FieldName="Gender" Caption="GENDER" VisibleIndex="2">
                    </dx:GridViewDataTextColumn>
            ...
            <dx:ASPxGridViewExporter ID="dataExporter" runat="server" GridViewID="dgAuthor" FileName="List of Book Authors"></dx:ASPxGridViewExporter>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
