...
namespace mySmis
{
    public partial class lessontimetable : System.Web.UI.Page
    {
        ...
        private void reloadLessonSchudel()
        {
            ...
            dgTimetable.DataSource = new LessonTimetableService().GetAllLessonTimetableByClassSchedID(int.Parse(cmbProgram.GridView.GetRowValues(cmbProgram.GridView.FocusedRowIndex, "ID").ToString()), "lessontimetable", new SessionManager().GetUserId(Session));
            dgTimetable.DataBind();
        }
