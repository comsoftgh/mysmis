<%@ Page Title="" Language="C#" MasterPageFile="~/tutor.Master" AutoEventWireup="true" CodeBehind="tutorexams.aspx.cs" Inherits="mySmis.tutorexams" %>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <dx:ASPxGridView KeyFieldName="ID" runat="server" Width="100%" ID="gvStudents" EnableCallBacks="False" AutoGenerateColumns="False" OnBatchUpdate="gvStudents_BatchUpdate" >
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="EXAMS SCORE" FieldName="ExamsMarks" Name="clLessonID" VisibleIndex="4">
                                                    </dx:GridViewDataTextColumn>
